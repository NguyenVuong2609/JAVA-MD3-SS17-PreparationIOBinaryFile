package Rikkei.academy.TH2_WriteObject;
...
public class Main {
    ...
    public static void main(String[] args) {
        String PATH_FILE = "src/Rikkei/academy/TH2_WriteObject/student.txt";
        List<Student> students = new ArrayList<>();
        ...
        List<Student> studentDataFromFile = readDataFromFile("src/Rikkei/academy/TH2_WriteObject/student.txt");
